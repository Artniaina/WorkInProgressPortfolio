...
const AboutFrame = () => {
  ...
  return (
    ...
    >
      <div className="flex justify-center lg:justify-start lg:ml-8 p-3 md:p-6 z-10 h-auto md:h-[38rem] w-full md:w-[30rem]">
        <motion.div
          className="w-full max-w-xs md:max-w-md rounded relative lg:left-[-2rem] border-2 border-purple-400 overflow-hidden flex flex-col"
          initial={{ scale: 0.8 }}
        ...
        >
          ...
          >
            <div className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-purple-700 border-2 border-purple-400 p-1">
          ...
          <div className="px-3 md:px-6 py-2 flex-grow text-center">
            <motion.div
              className="text-white text-xs md:text-sm font-bold mb-3 md:mb-6 -mt-2 px-2 text-center"
              initial={{ opacity: 0 }}
            ...
            <motion.div
              className="text-white text-base md:text-lg font-bold mb-2 md:mb-4 px-2"
              initial={{ opacity: 0 }}
              animate={inView ? { opacity: 1 } : {}}
              transition={{ duration: 0.5, delay: 0.4 }}
            >
            ...
            <div className="space-y-2 md:space-y-4">
              ...
              >
                <div className="w-6 h-6 md:w-8 md:h-8 bg-cyber-pink rounded-full flex items-center justify-center mr-2">
                  <div className="text-white text-base md:text-lg">
                    <CgMail className="text-white text-xl md:text-2xl" />
                  </div>
                </div>
          ...
          >
            <button className="bg-purple-500 hover:bg-purple-600 text-white px-4 md:px-6 py-1 md:py-2 rounded text-sm md:text-base">
              got it!
            </button>
          </motion.div>
        </motion.div>
