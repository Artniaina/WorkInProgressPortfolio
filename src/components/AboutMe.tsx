...
const AboutMe: React.FC = () => {
  ...
  return (
    <div id='about' className="flex items-center justify-center p-4">
              <motion.h1
      ...
      <div className="w-full max-w-4xl rounded-lg overflow-hidden border-4 border-gray-600 shadow-2xl" style={{ backgroundColor: 'rgba(58, 50, 100, 0.9)' }}>
        ...
        <div className="p-6 bg-black relative">
          ...
          {/* Text content */}
          <div className="text-white font-mono space-y-6 pr-10">
          <p className="leading-relaxed mb-8">
                I'm ANDRIAHARINIAINA Kanto Fitiavana <br />
            ...
            <div className="space-y-4 mb-8">
                <p className="text-pink-300 font-semibold">What drives me?</p>
                <p className="pl-4">
            ...
            <div className="space-y-4">
                <p className="text-pink-300 font-semibold">What am I currently learning?</p>
                <p className="pl-4">
