...
const Projects = () => {
  ...
  const ProjectCard = ({ project, index }: { project: any; index: number }) => (
    ...
    >
      ...
      className="absolute bottom-0 h-[2rem] mt-4 right-0 p-2 text-[0.7rem] font- font- text-white flex items-center space-x-1 hover:text-pink-400 transition md:text-xs bg-purple-800 rounded-tl-lg"
      >
  ...
  return (
    ...
    >
      {isInView && (
        <>
          <motion.div
            className="absolute top-20 left-[10%] w-32 h-32 rounded-full bg-purple-500 filter blur-3xl opacity-20 pointer-events-none"
            custom={0}
            initial="hidden"
            animate="visible"
          ...
          />
          <motion.div
            className="absolute bottom-40 right-[5%] w-48 h-48 rounded-full bg-pink-500 filter blur-3xl opacity-10 pointer-events-none"
            custom={1}
            initial="hidden"
            animate="visible"
            variants={bgElementVariants}
          />
          <motion.div
            className="absolute top-1/2 left-[30%] w-24 h-24 rounded-full bg-blue-500 filter blur-3xl opacity-10 pointer-events-none"
            custom={2}
            initial="hidden"
            animate="visible"
            variants={bgElementVariants}
      ...
      >
        ...
        <motion.div 
          variants={itemVariants}
          className="hidden md:flex justify-center items-center min-h-[41rem] w-full overflow-visible relative perspective-1000"
        >
          <div
        ...
        <motion.div 
          variants={itemVariants}
          className="md:hidden w-full flex justify-between items-center top-[4.6rem] mt-4 right-0 z-40 px-2 space-x-4"
        >
          <h2
