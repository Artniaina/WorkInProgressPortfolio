...
const education: EducationItem[] = [
  ...
  },
  {
    ...
    institution: "MPTC",
    period: "2021",
    description: "English Courses at: \"Madagascar Professional Training Centre\""
  },
  {
...
const Education = () => {
  ...
  return (
    <section id="education" className="py-12 md:py-20 bg-cyber-dark relative overflow-hidden">
      <motion.div 
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10" ref={ref}>
        ...
        >
          ...
          {education.map((edu, index) => (
            ...
            >
              <motion.div 
                className="absolute left-0 sm:left-1/2 -ml-3 h-6 w-6 rounded-full bg-pink-400 shadow-lg shadow-pink-400/50 border-2 border-white z-10 pixelated"
                initial={{ scale: 0 }}
                animate={inView ? { 
                  scale: 1,
              ...
              <motion.div
                ...
                className="p-6 sm:p-8 bg-[#2a002a] rounded-xl border border-[#3e003e] relative overflow-hidden group pixelated"
                whileHover={{
                  y: -5,
              ...
              >
                ...
                <motion.div
                  className="absolute inset-0 bg-gradient-to-br from-pink-500/0 to-transparent z-0 opacity-0"
                  whileHover={{ 
                    opacity: 0.15,
                ...
                <h3 className="text-xl  font-bold text-pink-400 mb-2 relative z-10 pixelated">{edu.title}</h3>
                <div className="flex flex-col  justify-between items-start sm:items-center mb-4 relative z-10">
                  ...
                  <motion.p 
                    className="text-gray-400 inline-block px-3 py-1 rounded-full bg-[#3e003e] text-sm pixelated"
                    whileHover={{
                ...
                <p className="text-gray-300 text-base  relative z-10">{edu.description}</p>
                
                <motion.div
                  className="absolute bottom-4 right-4 text-pink-400/20 text-6xl font-bold opacity-0 z-0 pixelated"
