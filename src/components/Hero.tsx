...
const Hero = () => {
  ...
  <div className='h-[93vh] relative bottom-4'>
    ...
    <Header/>
    <div className="max-w-8xl top-[8rem]  px-6 py-20 flex justify-start relative overflow-hidden">
      <div className="w-4xl flex flex-col relative -top-20 items-center left-12">
        <motion.h1
        ...
        >
          ...
          <br />
            <span className="text-pink-500 relative w-[35rem] left-[3rem] top-4 text-[1.5rem] mt-7 flex justify-start ">
            <ReactTyped
         strings={[
          "A JUNIOR DEVELOPER",
        ...
        <motion.p
          className="text-base mb-12 w-[32rem] top-6 left-4 relative  text-start"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
